...
public class TileInfo implements Comparable<TileInfo> {
	...
	static final byte TILE_BYTES_PER_PIXEL = 1;
	 ...
	 */
	TileInfo(long x, long y, byte zoomLevel) {
		this.x = x;
		this.y = y;
	...
	public int compareTo(TileInfo another) {
	...
	public String toString() {
		return "TileInfo: " + this.x + ", " + this.y + ", " + this.zoomLevel;
	}
}
